	...
	return (
		<div className='Document-layout'>
			<div className='Document-container'>
				...
				<p>
					This Privacy Policy explains how Players Club Management (“we”, “us”,
					or “our”) collects, uses, and discloses your Personal Information when
					you visit or make a purchase from our website (the “Site”).
				</p>
				...
				<p>
					...
					information if you contact us directly. “Personal Information” refers
					to any information that can uniquely identify you. Below are the types
					of Personal Information we collect and why:
				</p>

				<h3>Device Information</h3>
				<p>
					<b>Examples of data collected:</b> browser type, IP address, time
					zone, cookie data, pages/products viewed, search terms, and site
					...
					providers (e.g., Google Analytics, Shopify, or other platforms we
					use).
				</p>
				...
				<p>
					...
					payment details (credit card, Apple Pay, etc.), email address, and
					phone number.
					<b>Purpose:</b> to fulfill contracts, process payments, arrange
					services or product delivery, send confirmations, and communicate with
					you.
					...
					marketing platforms, or other vendors necessary to deliver our
					services.
				</p>

				<h3>Customer Support </h3>
				<p>
					<b>Examples of data collected:</b> any personal details you share
					while requesting support (e.g., contact details, case details).
					<b>Purpose:</b> to help resolve your issues and provide better
					service.
				...
				<ul>
					...
					<li>
						We may share data to comply with legal requirements or to enforce
						our rights.
					</li>
				</ul>
				...
				<p>
					We do not sell personal data in the conventional sense, but we may
					share it with third parties as described.
				</p>
